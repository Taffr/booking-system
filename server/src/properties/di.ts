import { db } from '../db';
import { getAllPropertiesFactory, addPropertyFactory, deletePropertyForUserFactory, updatePropertyForUserFactory } from './model';
...
export const updatePropertyController = updatePropertyControllerFactory(updatePropertyForUser)
