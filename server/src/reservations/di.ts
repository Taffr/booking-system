import { db } from '../db'
import { getReservationsForPropertyIdFactory, checkInToReservationFactory, createReservationFactory, deleteReservationForUserFactory } from './model'
import { getReservationsControllerFactory, checkInControllerFactory, createReservationControllerFactory, deleteReservationControllerFactory } from './controllers'
...
export const deleteReservationController = deleteReservationControllerFactory(deleteReservationForUser)
