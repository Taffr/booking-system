...
export type GetReservationsForPropertyId = ReturnType<
  typeof getReservationsForPropertyIdFactory
>;
export const getReservationsForPropertyIdFactory = (db: Connection) => {
